...
const Navbar = () =>
{
   ...
   return (
      <nav className="flex items-center justify-between pt-5">
         <img src={open ? "./src/assets/shared/icon-close.svg" : "./src/assets/shared/icon-hamburger.svg"} className="md:hidden  fixed right-5 cursor-pointer z-20 top-6" onClick={() => setopen(!open)} />
         <img src="./src/assets/shared/logo.svg" alt="logo" className="w-10 ml-7" />
